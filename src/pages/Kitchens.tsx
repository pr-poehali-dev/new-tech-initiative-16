    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative h-screen flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 lg:px-16 pb-16">
          <p className="text-orange-400 text-sm font-medium tracking-widest uppercase mb-3">Кухни на заказ</p>
      ...
      <div className="px-6 lg:px-16 py-20 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-5 text-white/90">Столешницы из любых материалов</h3>
